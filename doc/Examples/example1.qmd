...
Text formatting is achieved by enclosing words in asterisks. Using single asterisks produces *italic* text (e.g. `*italic*`), while double asterisks produce **bold** text (e.g. `**bold**`). One can also colored text using `[red text]{style="color: red;"}`, which produces a [text in red color]{style="color: red;"}.
